...
const tr: Dictionary = {
  ...
  workingModel: {
    ...
    subtitle: 'Dört aşamalı, yapılandırılmış ve ölçülebilir bir dönüşüm yaklaşımı.',
    phases: [
      {
        period: 'Adım 1',
        title: 'Teşhis Ederiz',
        description: 'Mevcut yapıyı, hizmet akışlarını, riskleri ve görünmeyen kayıpları analiz ederiz.',
        items: [
          'Mevcut hizmet akışlarının haritalanması',
          'Operasyonel risk ve kör noktaların tespiti',
          'Görünmeyen zaman ve iş gücü kayıplarının ölçülmesi',
          'Lokasyon bazlı uygulama sapmalarının değerlendirilmesi',
          'Çalışan deneyimi kırılma noktalarının belirlenmesi',
        ],
      },
      {
        period: 'Adım 2',
        title: 'Dokümante Ederiz',
        description: 'Şartname, prosedür, kontrol dosyası, denetim seti ve performans yapısını oluştururuz.',
        items: [
          'Hizmet şartname ve teknik spesifikasyonlar',
          'Politika ve prosedür dokümanları',
          'Kontrol dosyaları ve denetim checkliste',
          'Hizmet katalogu ve standart tanımları',
          'Rol ve sorumluluk matrisleri',
        ],
      },
      {
        period: 'Adım 3',
        title: 'Kontrol Altına Alırız',
        description: 'KPI, SLA, tedarikçi skor kartı ve saha denetim mekanizmaları kurarız.',
        items: [
          'KPI ve SLA yapılarının tanımlanması',
          'Tedarikçi performans skor kartları',
          'Saha denetim mekanizmaları ve takvimi',
          'İstisna yönetimi ve eskalasyon prosedürleri',
      ...
      },
      {
        period: 'Adım 4',
        title: 'Yerleştiririz',
        description: 'Modelin organizasyonda uygulanması için sorumluluklar, yönetim ritmi ve yaygınlaştırma planı hazırlarız.',
        items: [
          'Sorumluluk ve yetki atamalarının yapılması',
          'Yönetim ritmi ve toplantı düzeninin kurulması',
          'Lokal adaptasyon ve yaygınlaştırma planı',
          'Çalışan deneyimi geri bildirim döngüsü',
          'Sürekli iyileştirme mekanizmasının devreye alınması',
        ],
      },
    ],
  },
