...
const en: Dictionary = {
  ...
  workingModel: {
    tag: 'Methodology',
    title: 'How We Work',
    subtitle: 'A four-step, structured, and measurable transformation approach.',
    phases: [
      {
        period: 'Step 1',
        title: 'We Diagnose',
        description: 'We analyze the existing structure, service flows, risks, and invisible losses.',
        items: [
          'Mapping current service flows',
          'Identifying operational risks and blind spots',
          'Measuring invisible time and workforce losses',
          'Evaluating location-based application variances',
          'Identifying employee experience breaking points',
        ],
      },
      {
        period: 'Step 2',
        title: 'We Document',
        description: 'We create specifications, procedures, control files, audit sets, and performance structures.',
        items: [
          'Service specifications and technical requirements',
          'Policy and procedure documents',
          'Control files and audit checklists',
          'Service catalog and standard definitions',
      ...
      },
      {
        ...
        description: 'We establish KPIs, SLAs, vendor scorecards, and field audit mechanisms.',
        items: [
          'KPI and SLA structure definition',
          'Vendor performance scorecards',
          'Field audit mechanisms and calendar',
      ...
      },
      {
        period: 'Step 4',
        title: 'We Embed',
        description: 'We prepare responsibilities, management rhythm, and rollout plan for organizational implementation.',
        items: [
          'Responsibility and authority assignments',
          'Management rhythm and meeting cadence',
          'Local adaptation and rollout plan',
          'Employee experience feedback loop',
          'Continuous improvement mechanism activation',
        ],
      },
    ],
  },
